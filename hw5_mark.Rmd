...
3.  $\mathbb{P}(A|B)=\frac{\mathbb{P}(B)}{\mathbb{P}(A)}$
...
$$
Var(X) = E[(X-\tilde{X})^2]=\alpha*(3-\tilde{X})^2+\beta*(10-\tilde{X})^2\\
=9\alpha^3-18\alpha^2+69\alpha^2\beta+60\alpha\beta^2-100\beta^2-20\alpha\beta+9\alpha+100\beta
$$
...
$$
Std(X) = \sqrt{Var(X)}\\
=\sqrt{9\alpha^3-18\alpha^2+69\alpha^2\beta+60\alpha\beta^2-100\beta^2-20\alpha\beta+9\alpha+100\beta}
$$
...
=\sum_{i=1}^nVar(X_i)\\
=n(9\alpha^3+69\alpha^2\beta+60\alpha\beta^2-18\alpha^2-100\beta^2-20\alpha\beta+9\alpha+100\beta)
$$
